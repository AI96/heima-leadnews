...
public class ImageScan {
    ...
    public static void main(String[] args) throws Exception {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-shenzhen", "LTAI5tJYeBgTPgKnbioLuEFV", "g6shUFlsNLFWaxb5c0gRwTP051rnDN");
        DefaultProfile
                .addEndpoint("cn-shenzhen", "cn-shenzhen", "Green", "green.cn-shenzhen.aliyuncs.com");
        ...
        try{
            url = clientUploader.uploadFile("F:\\视频\\01-javaee\\01-Java课程\\07-项目二\\02-黑马头条\\02-双元\\day07\\资料\\图片\\ak47.jpg");
        }catch (Exception e){
            e.printStackTrace();
        }
